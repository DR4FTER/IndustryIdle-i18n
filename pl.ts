export const PL = {
    ...
    LumberMill: "Tartak",
    Lumber: "Ścięte drzewo",
    Paper: "Papier",
    PaperMill: "Fabryka papieru",
    Book: "Książka",
    BookPublisher: "Wydawnictwo książek",
    OilRefinery: "Rafineria",
    Sell: "Sprzedaj",
    Upgrade: "Ulepsz",
    Build: "Zbuduj",
    Inspect: "Zbadaj",
    ...
    FuelInStorage: "%{fuel} Zapasy",
    Plastic: "Plastik",
    FuelSurplus: "%{fuel} Nadwyżka",
    Petrol: "Benzyna",
    Buy: "Kup",
    NoLiquidity: "Brak płynności",
    NoLiquidityTurnOffAutoSell: "Brak wystarczającej płynności na rynku dla %{res}, automatyczna sprzedaż została wyłączona",
    Multiplier: "Mnożnik",
    MultiplierDesc: "Co 10 poziomów, mnożnik zwiększa się o +1",
    SellBuilding: "Sprzedaj budynek",
    PowerGrid: "Sieć energetyczna",
    TradeAmount: "Kwota handlu",
    SortBy: "Sortuj po",
    SortByPrice: "Cena",
    SortByAmount: "Ilość",
    NotEnoughResourcesForTrade: "Niewystarczająca ilość surowców w Centrum Handlu dla tej wymiany",
    NotEnoughResources: "Niewystarczająca ilość surowców dla tego działania",
    Transportation: "Transport",
    Cash: "Pieniądze",
    Aluminum: "Aluminium",
    ResearchPoint: "Punkt Badań",
    Unlock: "Odblokuj",
    BuildingUnlocked: "%{building} został odblokowany",
    Science: "Nauka",
    ScienceFromPowerDesc: "Elektrownie produkują małą ilość Nauki w trakcie generowania mocy",
    Culture: "Kultura",
    School: "Szkoła",
    ...
    Zeppelin: "Cepelin",
    ZeppelinFactory: "Fabryka cepelinów",
    Tank: "Czołg",
    ...
    Missile: "Pocisk",
    MissileFactory: "Fabryka pocisków",
    Rocket: "Rakieta",
    RocketFactory: "Fabryka rakiet",
    BuildingPermit: "Pozwolenie na budowę",
    BuildingPermitDesc:
        "Posiadasz pozwolenia na %{amount} budyn(ek/ków), do tej pory zbudowałeś %{amountBuilt} pozostało jeszcze %{amountLeft} pozwoleń",
    BuildingLocked: "Budynek nie jest jeszcze dostępny, najpierw musisz go odblokować w Laboratorium Badań",
    BuildQueue: "Kolejka budowania",
    BuildQueueDesc: "Ilość budynków w kolejce budowania",
    MaxBuilders: "Maksymalna ilość budowniczych",
    MaxBuildersDesc: "Ilość budynków, które możesz konstruować jednocześnie",
    Silicon: "Silikon",
    ...
    Headquarter: "Kwatera Główna",
    ResearchLab: "Laboratorium Badań",
    TradeCenter: "Centrum Handlu",
    Resources: "Zasoby",
